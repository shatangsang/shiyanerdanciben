    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonAdd.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(MainActivity.this, com.example.shiyanerdanciben.add.class);
        ...
        ButtonSeek.setOnClickListener(new View.OnClickListener(){       //点击跳转查询界面
            ...
            public void onClick(View v){
                ...
                if(EditTextSeekString.length()==0){             //查询为空，给出提示信息
                    ...
                    Intent intent = new Intent(MainActivity.this, com.example.shiyanerdanciben.search.class);
        ...
        ListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){      //配置ArrayList点击按钮
            ...
            public void  onItemClick(AdapterView<?> parent, View view , int position , long id){
                ...
                Intent intent = new Intent(MainActivity.this, com.example.shiyanerdanciben.edit.class);
